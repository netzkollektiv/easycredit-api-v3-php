...
/**
 * DeviceIdentToken Class Doc Comment
 *
 * @category Class
 * @package  Teambank\EasyCreditApiV3
 ...
 */
class DeviceIdentToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceIdentToken';
