...
class ShippingAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'packageStation' => 'setPackageStation'
    ];
    ...
    protected static $getters = [
        ...
        'packageStation' => 'getPackageStation'
    ];
     ...
     * Sets firstName
     *
     * @param string $firstName Should match with the first name given in the person data
     *
     * @return self
     */
     ...
     * Sets lastName
     *
     * @param string $lastName Should match with the last name given in the person data
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getPackageStation()
    {
        return $this->container['packageStation'];
    }

    /**
     * Sets packageStation
     *
     * @param bool|null $packageStation packageStation
     *
     * @return self
     */
    public function setPackageStation($packageStation)
    {
        $this->container['packageStation'] = $packageStation;
