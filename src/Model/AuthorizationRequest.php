...
class AuthorizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setOrderId($orderId)
    {
        if (!is_null($orderId) && (mb_strlen($orderId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling AuthorizationRequest., must be smaller than or equal to 50.');
        }
        if (!is_null($orderId) && (!preg_match("/[a-zA-Z0-9\\.:\\-_\/]*/", $orderId))) {
            throw new \InvalidArgumentException("invalid value for $orderId when calling AuthorizationRequest., must conform to the pattern /[a-zA-Z0-9\\.:\\-_\/]*/.");
        }
