...
class CustomerRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['orderDoneWithLogin'] === null) {
            $invalidProperties[] = "'orderDoneWithLogin' can't be null";
        }
     ...
     *
     * @param bool $orderDoneWithLogin true if the order was placed via customer login
     *
     * @return self
     */
