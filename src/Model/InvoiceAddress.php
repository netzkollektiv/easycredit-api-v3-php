...
class InvoiceAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets firstName
     *
     * @param string|null $firstName Optional, if present should match with the first name given in the person data
     *
     * @return self
     */
     ...
     * Sets lastName
     *
     * @param string|null $lastName Optional, if present should match with the last name given in the person data
     *
     * @return self
     */
