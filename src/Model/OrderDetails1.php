...
/**
 * OrderDetails1 Class Doc Comment
 *
 * @category Class
 * @package  Teambank\RatenkaufByEasyCreditApiV3
 * @author   OpenAPI Generator team
 ...
 */
class OrderDetails1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDetails1';
    ...
    public function setOrderId($orderId)
    {
        if (!is_null($orderId) && (mb_strlen($orderId) > 50)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling OrderDetails1., must be smaller than or equal to 50.');
        }
        if (!is_null($orderId) && (!preg_match("/[a-zA-Z0-9\\.:\\-_\/]*/", $orderId))) {
            throw new \InvalidArgumentException("invalid value for $orderId when calling OrderDetails1., must conform to the pattern /[a-zA-Z0-9\\.:\\-_\/]*/.");
        }
    ...
    public function setNumberOfProductsInShoppingCart($numberOfProductsInShoppingCart)
    {
        ...
        if (!is_null($numberOfProductsInShoppingCart) && ($numberOfProductsInShoppingCart > 10)) {
            throw new \InvalidArgumentException('invalid value for $numberOfProductsInShoppingCart when calling OrderDetails1., must be smaller than or equal to 10.');
        }
        if (!is_null($numberOfProductsInShoppingCart) && ($numberOfProductsInShoppingCart < 1)) {
            throw new \InvalidArgumentException('invalid value for $numberOfProductsInShoppingCart when calling OrderDetails1., must be bigger than or equal to 1.');
        }
    ...
    public function setShoppingCartInformation($shoppingCartInformation)
    {
        ...
        if (!is_null($shoppingCartInformation) && (count($shoppingCartInformation) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shoppingCartInformation when calling OrderDetails1., number of items must be greater than or equal to 1.');
        }
