 ...
 */
class TransactionListInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionListInfo';
    ...
    protected static $setters = [
        ...
        'pagingDetails' => 'setPagingDetails'
    ];
    ...
    protected static $getters = [
        ...
        'pagingDetails' => 'getPagingDetails'
    ];
    ...
    {
        return $this->container['transactionList'];
    }
    ...
    {
        $this->container['transactionList'] = $transactionList;
    ...
    {
        return $this->container['pagingDetails'];
    }
     ...
     * @return self
     */
    public function setPagingDetails($pagingDetails)
    {
        $this->container['pagingDetails'] = $pagingDetails;
