...
class Message implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets messageDE
     *
     * @param string|null $messageDE German error message whenever a booking (e.g REFUND/CAPTURE) related to a transaction fails
     *
     * @return self
     */
     ...
     * Sets messageEN
     *
     * @param string|null $messageEN error message whenever a booking (e.g REFUND/CAPTURE) related to a transaction fails
     *
     * @return self
     */
