...
$transactionInitRequest = new \Teambank\RatenkaufByEasyCreditApiV3\Model\TransactionInitRequest([
    'financingTerm' => 12,
...
try {
    ...
    echo 'go to: https://ratenkauf.easycredit.de/ratenkauf/content/intern/einstieg.jsf?vorgangskennung='.$result->getTechnicalTransactionId().PHP_EOL;

} catch (Exception $e) {
    print_r($e->getResponseObject());
    echo get_class($e).' when calling TransactionApi->apiPaymentV3TransactionPost: ', $e->getMessage(), PHP_EOL;
    exit;
}
